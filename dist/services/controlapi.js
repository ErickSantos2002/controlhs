...
api.interceptors.response.use((response) => response, async (error) => {
    ...
    if (((_a = error.response) === null || _a === void 0 ? void 0 : _a.status) === 401) {
        ...
        const isLoginRequest = (_c = (_b = error.config) === null || _b === void 0 ? void 0 : _b.url) === null || _c === void 0 ? void 0 : _c.includes('/login');
...
export async function register(username, password, role_name) {
...
export async function updateUserPassword(userId, novaSenha) {
    try {
...
export async function updateSetor(id, payload) {
...
export async function createPatrimonio(payload) {
    const { data } = await api.post('/patrimonios/', payload);
    return data;
}
export async function updatePatrimonio(id, payload) {
 ...
 * });
 */
export async function aprovarTransferencia(id, payload) {
 ...
 * });
 */
export async function rejeitarTransferencia(id, payload) {
 ...
 */
export async function efetivarTransferencia(id) {
...
export async function createBaixa(payload) {
 ...
 * await listAnexos(1);
 */
export async function listAnexos(patrimonioId) {
 ...
 */
export async function updateAnexo(id, payload) {
 ...
 */
export async function downloadAnexo(id, nomeOriginal) {
    try {
